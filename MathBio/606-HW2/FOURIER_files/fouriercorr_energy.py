...
for gg in E:
   ...
   for v in gg:
      ygrid = lb0 +iv*step0
      #print igg,iv, xgrid, ygrid, numpy.real(E[igg,iv])
      iv += 1
   igg += 1
'''
...
##Eshift = numpy.fft.fftshift(E)

ax = fig.add_subplot(1, 2, 1, projection='3d')
ax.set_title("real(E)")
surf3 = ax.plot_surface(xB,yB,numpy.real(E), cmap=cm.RdBu, linewidth=0, antialiased=True)
