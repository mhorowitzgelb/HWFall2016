...
def help_page():
   ...
   You must use 9 command line arguments:
     ...
     [10]  sigmaVdW, where 6-12 pot is 0.0 (default = 3.0)
     [11]  max well depth for VdW (default = 0.1)
     [12]  set all VdW greater than this value to this value (default = 100000.)
...
if __name__=='__main__':
	...
	if len(sys.argv) == 13:
		sigmaVdW = float(sys.argv[10])
		welldepthVdW = float(sys.argv[11])
		topval_VderWaals = float(sys.argv[12])
		ConVdW = welldepthVdW
